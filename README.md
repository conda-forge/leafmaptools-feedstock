...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/leafmaptools-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12178&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/leafmaptools-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `leafmaptools` can be installed with:

```
conda install leafmaptools
```

It is possible to list all of the versions of `leafmaptools` available on your platform with:
